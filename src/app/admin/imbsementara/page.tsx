            ...
            <table className="table-auto">
                <thead className="bg-slate-700 text-md text-slate-400 ">
                    <tr className="">
                        ...
                        <th className="p-3">Alamat Bangunan</th>
                        <th className="p-3">Tipe Bangunan</th>
                        <th className="p-3">Ukuran Bangunan</th>
                ...
                <tbody>
                    ...
                    <tr className="bg-slate-500 text-white">
                        ...
                        <td className="p-3">{item.alamatB}</td>
                        <td className="p-3">{item.type}</td>
                        <td className="p-3">{item.buildsize}</td>
