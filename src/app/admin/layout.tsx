...
export default function DashboardLayout({
    ...
    const surat = [
      {name: 'Surat Pengantar dari Kantor Desa', to:'/admin/suratpengantardesa'},
      {name: 'Surat Izin Membangun Sementara', to:'/admin/imbsementara'},
      ...
      {name: 'Surat Keterangan Pengurusan Kartu Keluarga', to:'/admin/suketpengurusankk'},
      ...
      {name: 'Surat Keterangan Belum Memiliki Rumah', to:'/admin/suketblmpunyarumah'},
